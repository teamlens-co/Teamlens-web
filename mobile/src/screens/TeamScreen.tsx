...
import type { User, UsageReportItem } from '../types';
  ...
  return (
    <ScreenShell>
      ...
      >
        ...
        <Text style={styles.subtitle}>{users.length} team members active</Text>
...
const styles = StyleSheet.create({
  ...
  scoreValue: { ...typography.bodySm, fontWeight: '800' },
  ...
  statusTagText: { fontSize: 11, fontWeight: '700', color: colors.success },
  ...
  usageTime: { ...typography.bodySm, fontWeight: '700', color: colors.muted },
});
