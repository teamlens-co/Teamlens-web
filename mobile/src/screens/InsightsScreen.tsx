...
const styles = StyleSheet.create({
  ...
  legendLabel: { ...typography.caption, textTransform: 'capitalize', fontWeight: '700' },
  legendValue: { ...typography.bodySm, fontWeight: '700' },
  ...
  itemMain: { flex: 1 },
  itemName: { ...typography.bodySm, fontWeight: '700', color: colors.text, marginBottom: 2 },
  categoryRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  dot: { width: 6, height: 6, borderRadius: 3 },
  itemCategory: { ...typography.caption, textTransform: 'capitalize' },
  itemTime: { ...typography.bodySm, fontWeight: '700', color: colors.muted },
